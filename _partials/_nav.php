<nav class="navbar navbar-expand-xxl bg-dark fixed-top" data-bs-theme="dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="?page=index"><img src="images/logo_trans-min.png" alt="Logo de Association La Team" class="logoNavbar"> La Team</a>
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <!-- <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="https://gnut06.sharepoint.com/sites/Gnut06" target="_blank">Le Hub La Team sur notre portail Microsoft</a></li>
            <li><a class="dropdown-item <?= (!empty($_GET['page']) && $_GET['page'] == "accueilGnut06") ? "active" : "" ?>" href="?page=accueilGnut06">Salle d'initialtion au métaverse La Team</a></li>
        ...
        <!-- <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Soutenir La Team</a>
          <ul class="dropdown-menu">
            <li class="nav-item">
              <a class="nav-link <?= (!empty($_GET['page']) && $_GET['page'] == "adhesion") ? "active" : "" ?>" href="?page=adhesion">Adhésion</a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?= (!empty($_GET['page']) && $_GET['page'] == "boutique") ? "active" : "" ?>" href="?page=boutique">Boutique La Team</a>
            </li>
            <li class="nav-item">
